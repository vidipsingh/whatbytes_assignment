...
const Header = () => {
  return (
    <div className='flex justify-between p-4 w-full border-b-[1.5px]'>
        ...
        <div className='sm:flex hidden text-black items-center gap-2 border-2 border-gray-200 px-1 py-1 rounded-md cursor-pointer'>
